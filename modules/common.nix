...
# =============================================================
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    # wl-mirror открывает содержимое одного выхода обычным окном, которое
    # дальше можно вывести на весь экран на другом мониторе.
    #   wl-mirror DP-2        — зеркалить Dell
    #   wl-mirror -f DP-2     — сразу во весь экран
    wl-mirror
    # сеть
    hysteria
