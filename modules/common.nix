...
# =============================================================
{
  ...
  environment.systemPackages = with pkgs; [
    ...
    #   Голый пакет, без конфига: префикс Ctrl-b, копирование во внутренний
    #   буфер (не в wl-clipboard), прокрутка через Ctrl-b [. Если понадобится
    #   своя раскладка клавиш и связка с wl-copy — это programs.tmux
    #   в home-manager, здесь его нет.
    tmux
